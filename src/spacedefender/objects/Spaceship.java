...
public abstract class Spaceship extends GameObject {
	...
	protected void fireProjectiles(Vector2f velocity, Projectile p) {
		timeSinceLastShot = 0;
		projectilesUp[currentProjectile] = new Projectile(
				position.copy().add(new Vector2f(projectilesShipInterspace, 0)), velocity);
		projectilesDown[currentProjectile] = new Projectile(
				position.copy().add(new Vector2f(projectilesShipInterspace, projectilesInterspace)), velocity);
		currentProjectile++;
